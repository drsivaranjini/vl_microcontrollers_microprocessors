    ...
    <>
      ...
      <section>
        ...
        <Editor8051
          ...
          resultHint="this program writes its result to external memory (MOVX), not internal RAM — in the Memory panel, switch the dropdown from RAM to XRAM, then check 9200H (sum) and 9201H (carry)."
        />
      </section>
